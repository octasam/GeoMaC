...
def numericalDer(f, x0, h, aprox = 'All'):
    ...
    e3 = np.fabs(fp_value - FD_D3(evalf, x0, h))
    ...
    fig.suptitle('EF = {:10.4e}, EB = {:10.4e}, EC = {:10.4e}, ED3 = {:10.4e}'.format(ef,eb,ec,e3))
    ...
    if aprox == 'All':
        ...
        plt.plot(xl, l3, lw = ancho_linea, label="f' = D3")   
    ...
    if aprox == 'All':
        ...
        plt.plot(xv, FD_D3(evalf, xv, h), lw = ancho_linea)
    elif aprox == 'Forward':
        plt.plot(xv, forwardFD(evalf, xv, h), lw = ancho_linea)
    elif aprox == 'Backward':
        plt.plot(xv, backwardFD(evalf, xv, h), lw = ancho_linea)
...
if __name__ == '__main__':
    ...
    daprox = DataFrame(aprox.transpose(), 
                       columns = ['h', 'original', 'forward', 'backward', 'centered', 'FD_D3'])
    print(daprox)
