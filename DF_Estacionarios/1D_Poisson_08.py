...
try:
    ...
    mensaje = """ Error: La ejecucion de este programa requiere de 2 argumentos. 
        Ejecucion correcta: python 1D_Poisson_08.py entrada salida
        ...
        Por ejemplo: python 1D_Poisson_08.py INPUT_02 SALIDA"""
    print(mensaje)
    sys.exit(1)
...
poisson1D.GraficaSolucion(x,u,xa,ua,GTit,NSolTit,ESolTit,"1D_Poisson_08.pdf")
